...
router.post(
  "/create-profile",
  asyncHandler(adsPowerController.handleCreateProfile),
);
router.get("/profiles", asyncHandler(adsPowerController.listAdsPowerProfiles));
router.put(
  "/profiles/:userId",
  asyncHandler(adsPowerController.updateAdsPowerProfile),
);
router.post(
  "/profiles/delete-bulk",
  asyncHandler(adsPowerController.deleteAdsPowerProfiles),
);
router.post(
  "/profiles/regroup",
  asyncHandler(adsPowerController.regroupAdsPowerProfiles),
);
router.post(
...
router.get(
  ...
  asyncHandler(adsPowerController.stopAdsPowerBrowser),
);
router.get(
...
router.get(
  ...
  asyncHandler(adsPowerController.getAdsPowerProfileDetail),
);
...
router.post(
  "/groups/update",
  asyncHandler(adsPowerController.updateAdsPowerGroup),
);

// Trasa do usuwania grup AdsPower (bulk)
router.post(
  "/groups/delete-bulk",
  asyncHandler(adsPowerController.deleteAdsPowerGroups),
);
