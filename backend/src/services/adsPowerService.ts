...
class AdsPowerService {
  ...
  public async checkApiStatus(): Promise<AdsPowerResponse<AdsPowerGroupListData> | null> {
    try {
      ...
      const response = await this.apiClient.get<
        AdsPowerResponse<AdsPowerGroupListData>
      >("/api/v1/group/list", {
        params: {
      ...
      if (axios.isAxiosError(error)) {
        console.error(
          "Axios error connecting to AdsPower API (checkApiStatus):",
          error.message,
        );
        if (error.response) {
          console.error(
            "AdsPower API error response status:",
          ...
          console.error(
            "AdsPower API no response received. Request details:",
            error.request,
          );
        } else {
          console.error(
            "Error setting up AdsPower API request:",
            error.message,
          );
        }
      } else {
  ...
  public async createProfile(
    ...
    try {
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<CreateProfileResponseData>
      >(endpoint, payload);
      console.log(
      ...
      console.error(
        `Error creating AdsPower profile. Message: ${axiosError.message}`,
      );
      console.error(
      ...
      if (axiosError.response && axiosError.response.data) {
        return axiosError.response
          .data as AdsPowerResponse<CreateProfileResponseData>;
      }
      return null;
    }
  }
  ...
  public async listProfiles(
    ...
    try {
      ...
      const response = await this.apiClient.get<
        AdsPowerResponse<AdsPowerProfileListData>
      >(endpoint, {
        params: {
      ...
      console.error(
        `Error listing AdsPower profiles. Message: ${axiosError.message}`,
      );
      if (axiosError.response) {
        console.error(
      ...
      if (axiosError.response && axiosError.response.data) {
        return axiosError.response
          .data as AdsPowerResponse<AdsPowerProfileListData>;
      }
      return null;
    }
  }
  ...
  public async updateProfile(
    ...
    try {
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<UpdateProfileResponseData>
      >(endpoint, payload);
      console.log(
      ...
      if (axiosError.response) {
        ...
        // Zwróć dane błędu z odpowiedzi AdsPower, jeśli są dostępne
        return axiosError.response
          .data as AdsPowerResponse<UpdateProfileResponseData>;
      } else if (axiosError.request) {
        console.error(
  ...
  public async deleteProfiles(
    ...
    try {
      console.log(
        `Attempting to delete AdsPower profiles from URL: ${fullUrl}`,
      );
      console.log(
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<DeleteProfilesResponseData>
      >(endpoint, payload);
      console.log(
      ...
      const axiosError = error as AxiosError;
      console.error(
        `Error deleting AdsPower profiles. Message: ${axiosError.message}`,
      );
      console.error(
      ...
      if (axiosError.response) {
        ...
        // Zwróć dane błędu z odpowiedzi AdsPower, jeśli są dostępne
        return axiosError.response
          .data as AdsPowerResponse<DeleteProfilesResponseData>;
      } else if (axiosError.request) {
        console.error(
  ...
  public async regroupProfiles(
    ...
    try {
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<RegroupProfilesResponseData>
      >(endpoint, payload);
      console.log(
      ...
      const axiosError = error as AxiosError;
      console.error(
        `Error regrouping AdsPower profiles. Message: ${axiosError.message}`,
      );
      console.error(
      ...
      if (axiosError.response) {
        ...
        return axiosError.response
          .data as AdsPowerResponse<RegroupProfilesResponseData>;
      } else if (axiosError.request) {
        console.error(
  ...
  public async clearAllProfilesCache(): Promise<AdsPowerResponse<ClearAllProfilesCacheResponseData> | null> {
    ...
    try {
      console.log(
        `Attempting to clear all AdsPower profiles cache at URL: ${fullUrl}`,
      );
      ...
      const axiosError = error as AxiosError;
      console.error(
        `Error clearing all AdsPower profiles cache. Message: ${axiosError.message}`,
      );
      if (axiosError.response) {
        console.error(
        ...
        return axiosError.response
          .data as AdsPowerResponse<ClearAllProfilesCacheResponseData>;
      } else if (axiosError.request) {
        console.error(
  ...
  public async startBrowser(
    ...
    try {
      ...
      const response = await this.apiClient.get<
        AdsPowerResponse<StartBrowserResponseData>
      >(endpoint, { params });
      console.log(
      ...
      if (axiosError.response) {
        ...
        return axiosError.response
          .data as AdsPowerResponse<StartBrowserResponseData>;
      } else if (axiosError.request) {
        console.error(
  ...
  public async stopBrowser(
    ...
    try {
      ...
      const response = await this.apiClient.get<
        AdsPowerResponse<StopBrowserResponseData>
      >(endpoint, { params });
      console.log(
      ...
      if (axiosError.response) {
        ...
        return axiosError.response
          .data as AdsPowerResponse<StopBrowserResponseData>;
      } else if (axiosError.request) {
        console.error(
        ...
        console.error(
          "Error setting up AdsPower API request (stopBrowser):",
          axiosError.message,
        );
      }
      return null;
  ...
  public async checkBrowserStatus(
    ...
    try {
      ...
      const response = await this.apiClient.get<
        AdsPowerResponse<BrowserStatusResponseData>
      >(endpoint, { params });
      console.log(
      ...
      if (axiosError.response) {
        ...
        return axiosError.response
          .data as AdsPowerResponse<BrowserStatusResponseData>;
      } else if (axiosError.request) {
        console.error(
  ...
  public async createGroup(
    ...
    try {
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<CreateGroupResponseData>
      >(endpoint, payload);
      console.log(
      ...
      const axiosError = error as AxiosError;
      console.error(
        `Error creating AdsPower group. Message: ${axiosError.message}`,
      );
      console.error(
      ...
      if (axiosError.response) {
        ...
        return axiosError.response
          .data as AdsPowerResponse<CreateGroupResponseData>;
      } else if (axiosError.request) {
        console.error(
        ...
        console.error(
          "Error setting up AdsPower API request (createGroup):",
          axiosError.message,
        );
      }
      return null;
  ...
  public async listGroups(
    ...
    try {
      ...
      const axiosError = error as AxiosError;
      console.error(
        `Error listing AdsPower groups. Message: ${axiosError.message}`,
      );
      if (axiosError.response) {
        console.error(
        ...
        return axiosError.response
          .data as AdsPowerResponse<AdsPowerGroupListData>;
      } else if (axiosError.request) {
        console.error(
        ...
        console.error(
          "Error setting up AdsPower API request (listGroups):",
          axiosError.message,
        );
      }
      return null;
  ...
  public async updateGroup(
    ...
    try {
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<UpdateGroupResponseData>
      >(endpoint, payload);
      console.log(
      ...
      console.error(
        "Request payload for failed group update:",
        JSON.stringify(payload, null, 2),
      );
      if (axiosError.response) {
        console.error(
        ...
        return axiosError.response
          .data as AdsPowerResponse<UpdateGroupResponseData>;
      } else if (axiosError.request) {
        console.error(
        ...
        console.error(
          "Error setting up AdsPower API request (updateGroup):",
          axiosError.message,
        );
      }
      return null;
  ...
  public async deleteGroups(
  ...
  ): Promise<AdsPowerResponse<DeleteGroupsResponseData> | null> {
    ...
    try {
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<DeleteGroupsResponseData>
      >(endpoint, payload);
      console.log(
      ...
      const axiosError = error as AxiosError;
      console.error(
        `Error deleting AdsPower groups. Message: ${axiosError.message}`,
      );
      console.error(
      ...
      if (axiosError.response) {
        ...
        return axiosError.response
          .data as AdsPowerResponse<DeleteGroupsResponseData>;
      } else if (axiosError.request) {
        console.error(
  ...
  public async getProfileDetail(
    ...
    try {
      ...
      if (axiosError.response) {
        ...
        // Zwróć dane błędu z odpowiedzi AdsPower, jeśli są dostępne
        return axiosError.response
          .data as AdsPowerResponse<AdsPowerProfileDetailData>;
      } else if (axiosError.request) {
        console.error(
      ...
      return {
        ...
        msg:
          axiosError.message ||
          "Failed to get profile detail due to an unexpected error.",
        data: null as any, // Zgodnie z typem Promise
      };
    }
  }
