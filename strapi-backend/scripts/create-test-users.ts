  ...
  try {
    ...
    await strapi.documents('api::staff.staff').create({
      data: {
        ...
        user: adminUser.id, // DODANE: powiązanie z użytkownikiem
    ...
    await strapi.documents('api::staff.staff').create({
      data: {
        ...
        position: 'staff',
        hireDate: new Date().toISOString().split('T')[0],
        user: staffUser.id, // DODANE: powiązanie z użytkownikiem
        publishedAt: new Date(),
      },
    });
    ...
    await strapi.documents('api::supplier.supplier').create({
      data: {
        ...
        country: 'Polska',
        nip: '1234567890',
        user: supplierUser.id, // DODANE: powiązanie z użytkownikiem
        publishedAt: new Date(),
      },
    });
