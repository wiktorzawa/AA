          ...
          <form action="#">
            <div className="mb-4 grid gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 dark:focus:ring-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400"
              ...
              <div className="flex items-center gap-x-3">
                <AvatarGroup className="[&_img]:ring-white [&_img]:dark:ring-gray-800">
                  <Avatar
                    alt="Helene Engles"
