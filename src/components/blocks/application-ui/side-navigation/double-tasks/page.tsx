        ...
        <DrawerItems className="h-full">
          <Sidebar collapsed className="border-r dark:border-gray-700">
            <SidebarItemGroup className="[&_[role=tooltip]]:hidden [&_svg]:text-gray-400">
              ...
              <SidebarItem href="#" icon={HiFolderDownload} />
            </SidebarItemGroup>
            <SidebarItemGroup>
              <SidebarItem href="#" icon={HiPlus} />
            </SidebarItemGroup>
          </Sidebar>
          <Sidebar>
            <SidebarItems>
              <SidebarItemGroup>
                <div>
                  ...
                  >
                    <DropdownItem className="border-b py-3 dark:border-gray-600">
                      <svg
                        aria-hidden="true"
              ...
              <SidebarItemGroup>
                <div className="mb-4 flex items-center justify-between">
                  ...
                  >
                    <DropdownItem>Mark all as done</DropdownItem>
                    <DropdownItem>Remove all items</DropdownItem>
                    <DropdownItem>Add to my day</DropdownItem>
                  </Dropdown>
                </div>
