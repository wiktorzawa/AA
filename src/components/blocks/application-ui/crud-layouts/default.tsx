                ...
                >
                  <div className="p-3">
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex items-center">
                        <Checkbox defaultChecked id="razer" name="razer" />
                        <Label
                          htmlFor="razer"
                          className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100"
                        >
                ...
                <TableRow className="border-b dark:border-gray-700">
                  ...
                  <TableCell className="flex items-center justify-end p-5">
                    ...
                    >
                      ...
                      <DropdownItem onClick={() => setShowReadModal(true)}>
                        <svg
                          className="mr-2 h-4 w-4"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <Button
                ...
                outline
                size="lg"
                className="[&>span]:text-sm dark:[&>span]:bg-transparent [&>span]:dark:text-gray-400"
              >
                Preview
              </Button>
            </div>
