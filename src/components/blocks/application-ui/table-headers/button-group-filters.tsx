      ...
      <div className="mx-auto w-full max-w-screen-xl px-4 lg:px-12">
        <div className="relative bg-white shadow-md sm:rounded-lg dark:bg-gray-800">
          <div className="divide-y px-4 dark:divide-gray-700">
            <div className="flex flex-col space-y-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 sm:space-x-4">
            ...
            <div className="flex flex-col items-stretch justify-between space-y-3 py-4 sm:flex-row sm:items-center sm:space-y-0">
              <div className="block items-center space-y-2 sm:flex sm:space-y-0">
                ...
                <div className="flex items-center">
                  ...
                  <ButtonGroup className="mx-4 hidden w-full flex-col md:flex md:w-auto md:flex-row">
                    <Button
                      color="gray"
                      className="rounded-r-lg rounded-b-none md:rounded-r-none md:rounded-b-lg dark:bg-gray-700 dark:text-white dark:enabled:hover:bg-gray-600"
                    >
                      Positions
                    </Button>
                    <Button
                  ...
                  <a
                    href="#"
                    className="text-primary-600 dark:text-primary-500 flex shrink-0 items-center text-sm font-medium hover:underline"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="flex w-full shrink-0 flex-col items-stretch justify-end space-y-2 sm:w-auto sm:flex-row sm:items-center sm:space-y-0 sm:space-x-3">
