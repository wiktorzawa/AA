import { Dropdown, DropdownItem, Footer, theme, Tooltip } from "flowbite-react";
      ...
      <div className="mb-4 md:mb-0 xl:flex xl:items-center xl:space-x-3">
        ...
        <ul className="flex items-center justify-center">
          <li>
            <a
              href="#"
              className="mr-6 text-gray-900 underline hover:no-underline dark:text-white"
            >
              Privacy Policy
            </a>
          </li>
          ...
          <li>
            <a
              href="#"
              className="text-gray-900 underline hover:no-underline dark:text-white"
            >
              Contact
            </a>
          </li>
