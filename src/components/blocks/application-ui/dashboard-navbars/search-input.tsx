...
export function DoubleDashboardNavbarWithSearchInput() {
  return (
    <header>
      <Navbar
        fluid
        className="border-gray-200 bg-white px-0 py-2.5 antialiased dark:bg-gray-900"
      >
        <div className="flex w-full flex-wrap items-center justify-between">
          ...
          <div className="mt-4 w-full bg-white dark:bg-gray-900">
            <form className="w-full px-4 lg:max-w-xl lg:px-6">
              <div className="flex">
                ...
                >
                  <DropdownItem>https only</DropdownItem>
                  <DropdownItem>http</DropdownItem>
                  <DropdownItem>http + https</DropdownItem>
                </Dropdown>
                <div className="relative flex w-full">
                  <TextInput
                    ...
                    required
                    type="search"
                    className="w-full [&_input]:rounded-r-none [&_input]:md:rounded-l-none"
                  />
                  <Dropdown
                    color="gray"
                    label={
                  ...
                  >
                    <DropdownItem>Subfolders</DropdownItem>
                    <DropdownItem>Subdomains</DropdownItem>
                    <DropdownItem>Full domain</DropdownItem>
                  </Dropdown>
                  <button
                    type="submit"
            ...
            >
              <NavbarLink className="px-4">
                <Dropdown
                  ...
                  theme={{
                    ...
                    inlineWrapper: twMerge(
                      theme.dropdown.inlineWrapper,
                      "w-full justify-between text-sm font-medium text-gray-700 dark:text-white",
                    ),
                  }}
                >
                  <ul className="space-y-1 p-3 text-sm text-gray-700 dark:text-gray-200">
              ...
              <NavbarLink
                href="#"
                className="px-4 text-sm font-medium dark:text-white"
              >
                Home
              </NavbarLink>
              <NavbarLink
              ...
              <NavbarLink className="px-4">
                <Dropdown
                  ...
                  theme={{
                    ...
                    inlineWrapper: twMerge(
                      theme.dropdown.inlineWrapper,
                      "w-full justify-between text-sm font-medium dark:text-white",
                    ),
                  }}
                >
                  <DropdownItem>Dashboard</DropdownItem>
