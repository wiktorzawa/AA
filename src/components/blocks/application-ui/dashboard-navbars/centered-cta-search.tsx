      ...
      >
            ...
            <div className="ml-4 flex shrink-0 items-center justify-between lg:order-2">
              ...
              <Dropdown
                ...
                theme={{
                  ...
                  inlineWrapper: twMerge(
                    ...
                    "mr-2 rounded-lg p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-300 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600",
                  ),
                }}
              >
              ...
              <Dropdown
                ...
                theme={{
                  ...
                  inlineWrapper: twMerge(
                    theme.dropdown.inlineWrapper,
                    "mx-3 text-gray-600 dark:text-gray-400",
                  ),
                }}
              >
        ...
        <NavbarCollapse className="order-3 border-t bg-white px-4 py-2.5 shadow-sm md:order-2 lg:px-6 dark:border-gray-800 dark:bg-gray-900">
          <div className="flex w-full flex-col items-center justify-between md:flex-row">
            ...
            <form className="order-1 mb-4 flex w-full items-center justify-end md:order-2 md:mb-0 md:ml-4 md:max-w-sm">
