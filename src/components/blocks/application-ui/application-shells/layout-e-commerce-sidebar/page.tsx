            ...
            <div className="flex items-center justify-start">
              ...
              <div className="hidden items-center lg:flex">
                ...
                >
                  ...
                  <DropdownItem>Instruments</DropdownItem>
                  <DropdownItem>Clothings</DropdownItem>
                </Dropdown>
                <TextInput
                  id="search"
                  name="search"
            ...
            <div className="h-full overflow-y-auto bg-white pt-1 lg:rounded-lg dark:bg-gray-800">
              ...
              <div>
                ...
                <SidebarItems className="[&_*]:font-medium">
                  <SidebarItemGroup>
                    <SidebarItem href="#" icon={HiPresentationChartBar}>
                      Overview
                    </SidebarItem>
                    <SidebarCollapse icon={HiTruck} label="Orders">
                      <SidebarItem href="#">Completed orders</SidebarItem>
                      <SidebarItem href="#">Orders in delivery</SidebarItem>
                      <SidebarItem href="#">Canceled orders</SidebarItem>
                      <SidebarItem href="#">Returns</SidebarItem>
                    </SidebarCollapse>
                  ...
                  <SidebarItemGroup>
                    ...
                    <SidebarItem href="#" icon={HiIdentification}>
                      Personal info
                    </SidebarItem>
                    <SidebarItem href="#" icon={HiCreditCard}>
                      Subscriptions
                    </SidebarItem>
                    <SidebarItem
                      href="#"
