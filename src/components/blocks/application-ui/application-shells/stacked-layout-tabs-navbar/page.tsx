...
export default function StackedLayoutWithTabsAndNavbar() {
  return (
    <div className="bg-gray-100 dark:bg-gray-900">
      <Navbar
        fluid
        className="fixed top-0 z-50 w-full border-b bg-white p-0 sm:p-0 lg:border-none dark:border-gray-700 dark:bg-gray-800"
      >
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3 flex items-center">
                  ...
                  >
                    ...
                    <DropdownItem className="hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                      My profile
                    </DropdownItem>
                    <DropdownItem className="hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                      Account settings
                    ...
                    <DropdownDivider />
                    <DropdownItem className="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                      <svg
                    ...
                    <DropdownItem className="flex items-center justify-between px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <DropdownDivider />
                    <DropdownItem className="hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                      Sign out
                    </DropdownItem>
                  </Dropdown>
                </div>
        ...
        <NavbarCollapse className="hidden justify-center bg-gray-100 pt-6 lg:flex lg:w-full dark:bg-gray-900">
          <div className="flex flex-col items-center border-b border-gray-200 bg-gray-100 shadow-sm lg:flex-row dark:border-gray-800 dark:bg-gray-900 [&_li]:w-full lg:[&_li]:w-auto">
            <NavbarLink
              aria-current="page"
              href="#"
        ...
        <div className="w-full border-t bg-gray-100 p-3 lg:hidden dark:border-gray-700 dark:bg-gray-800">
