    ...
    <div className="bg-gray-50 dark:bg-gray-900">
          ...
          >
            <div className="flex h-full flex-col justify-between py-3">
              <div>
                ...
                <SidebarItems className="pb-32 [&_*]:font-medium">
                  <SidebarItemGroup>
      ...
      >
        <SidebarItemGroup>
          ...
          <SidebarItem href="#" icon={HiLightBulb} label="Notes">
            Notes
          </SidebarItem>
          <SidebarItem href="#" icon={HiClipboardCheck} label="To-do list">
            To-do list
          </SidebarItem>
          <SidebarItem href="#" icon={HiUsers} label="Users">
            Users
          </SidebarItem>
          <SidebarItem href="#" icon={HiVideoCamera} label="Media">
            Media
          </SidebarItem>
        </SidebarItemGroup>
        <SidebarItemGroup>
          ...
          <SidebarItem href="#" icon={HiLocationMarker} label="Locations">
            Locations
          </SidebarItem>
          <SidebarItem href="#" icon={HiPlus} label="New item">
            New item
          </SidebarItem>
        </SidebarItemGroup>
      </Sidebar>
