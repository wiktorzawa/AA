import { Avatar, AvatarGroup, AvatarGroupCounter, Button } from "flowbite-react";
import {
  HiCalendar,
  HiLocationMarker,
  HiPencilAlt,
        ...
        <div className="mb-4 grid gap-4 px-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12">
          ...
          <dl className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700">
            ...
            <dd className="mb-4 flex -space-x-4 sm:mb-5">
              <AvatarGroup className="[&_*]:ring-gray-100 [&_*]:dark:ring-gray-700">
                <Avatar
                  alt="Helene Engels"
                ...
                <Avatar
                  ...
                  stacked
                />
                <AvatarGroupCounter total={9} className="h-8 w-8 bg-gray-600" />
              </AvatarGroup>
            </dd>
            <dt className="mb-2 leading-none text-gray-500 dark:text-gray-400">
              Online
