      ...
      <div className="mx-auto max-w-6xl px-4 py-8 lg:py-16">
        ...
        <div className="mb-4 grid gap-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12">
          <div className="sm:col-span-2">
              ...
              theme={{
                control: {
                  base: twMerge(
                    ...
                    "bg-gray-200 group-hover:bg-gray-300 group-focus:ring-4 group-focus:ring-white group-focus:outline-none dark:bg-gray-600 dark:group-hover:bg-gray-500 dark:group-focus:ring-gray-800/70",
                  ),
                  icon: twMerge(
            ...
            <p className="mb-4 text-gray-500 sm:mb-5 dark:text-gray-400">
