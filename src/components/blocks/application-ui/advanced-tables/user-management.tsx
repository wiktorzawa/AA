          ...
          <div className="divide-y px-4 dark:divide-gray-700">
            ...
            <div className="flex flex-col items-stretch justify-between space-y-3 py-4 md:flex-row md:items-center md:space-y-0">
              ...
              <ButtonGroup className="flex-col md:flex-row">
                <Button
                  color="gray"
                  className="w-full rounded-t-lg rounded-b-none md:w-fit md:rounded-r-none md:rounded-bl-lg dark:bg-gray-700 dark:hover:bg-gray-600"
                >
                  Suspend all
                </Button>
                <Button
                  color="gray"
                  className="w-full md:w-fit dark:bg-gray-700 dark:hover:bg-gray-600"
                >
                  Archive all
                </Button>
                <Button
                  color="gray"
                  className="w-full rounded-t-none rounded-bl-lg md:w-fit md:rounded-tr-lg md:rounded-bl-none dark:bg-gray-700 dark:hover:bg-gray-600"
                >
                  Delete all
                </Button>
              </ButtonGroup>
            ...
            >
              ...
              <TableBody>
                <TableRow className="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <TableCell
                    scope="row"
                    className="px-4 py-2 font-medium whitespace-nowrap text-gray-900 dark:text-white"
                  >
                    <div className="flex items-center">
                      <img
                  ...
                  <TableCell className="px-4 py-2">20 Nov 2022</TableCell>
                  <TableCell className="px-4 py-2 font-medium whitespace-nowrap text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={
                ...
                <TableRow className="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <TableCell className="px-4 py-2">23 Nov 2022</TableCell>
                  <TableCell className="px-4 py-2 font-medium whitespace-nowrap text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={
                ...
                <TableRow className="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <TableCell className="px-4 py-2">19 Nov 2022</TableCell>
                  <TableCell className="px-4 py-2 font-medium whitespace-nowrap text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={
                ...
                <TableRow className="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <TableCell className="px-4 py-2">27 Nov 2022</TableCell>
                  <TableCell className="px-4 py-2 font-medium whitespace-nowrap text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={
                ...
                <TableRow className="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <TableCell className="px-4 py-2">18 Nov 2022</TableCell>
                  <TableCell className="px-4 py-2 font-medium whitespace-nowrap text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={
